...
def calculation_simulator():
    """
    Запускает тренажер счета в уме.

    Выводит служебные сообщения, принимает и проверяет ответы
    пользователя, ведет статистику и управляет количеством жизней.
    """
    total_answers: int = 0
